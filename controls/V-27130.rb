control "V-27130" do
  ...
  tag "check": "Application must utilize approved cryptography to protect the communication
	...
	finding.
	"
  tag "fix": "Implement protective measures when establishing a trusted communication path
	between entities.
