control "V-26910" do
  ...
  tag "check": "Application must utilize bidirectional authentication for cryptographic device
	communication.

	As the application administrator (usually
	elasticsearch), check the xpack.ssl settings are set to the correct values.
	...
	finding.
	"
  tag "fix": "Implement bidirectional (client-server handshake) for establishing
	cryptographic communication.

	 See the official documentation for the
	complete  guide on establishing SSL configuration:
