control "V-27060" do
  ...
  tag "cci": "CCI-001130"
  tag "nist": ["SC-9", "Rev_3"]
  tag "check": "Application must utilize approved cryptography to establish confidentiality of
	transmitted data.
  ...
  tag "fix": "Implement confidentiality measures of transmitted data.
	 ...
	 See the
	official documentation for the complete  guide on establishing SSL
