control "V-26967" do
  title "The application must reject or delay, as defined by the organization,
network traffic generated above configurable traffic volume thresholds."
...
endpoint can be built as an action in Watcher."
  ...
  tag "stig_id": "SRG-APP-000106"
  tag "cci": "CCI-001574"
  tag "check": "Verify the audit records are stored on a seperate disk then
operating system.
...
separate partition), this is a finding."
  tag "fix": "Configure the audit storage to a seperate partition for audit
storage.
