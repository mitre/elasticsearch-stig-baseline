...
ELASTIC_IP= attribute(
  'elastic_ip',
  description: 'IP address of the elastic instance',
  default: "0.0.0.0"
)

ELASTIC_PORT= attribute(
  'elastic_port',
  description: 'Port number of the elastic instance',
  default: "9200"
)

ELASTICSEARCH_CONF_FILE = attribute(
...
control "﻿V-26681" do
  title "Encrypt information in transit both at the application and Elasticsearch
	perimeter and within the Elasticsearch cluster
	"
  desc  "
  ...
  tag "check": "Application must utilize approved cryptography to protect remote access
	...
	If these setting are not set or the underlining certificate and keys are not correct,
	this is a finding.
